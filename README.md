...
https://docs/screenshots/02-dashboard.png
...
📸 Captures d'écran
Connexion
https://docs/screenshots/01-login.png

Tableau de bord
https://docs/screenshots/02-dashboard.png

Prévisions IA
https://docs/screenshots/09-ai-predictions.png

Liste des patients
https://docs/screenshots/03-patients.png

Dossier médical d'un patient
https://docs/screenshots/04-patient-detail.png

Formulaire patient
https://docs/screenshots/05-patient-form.png

Prise de rendez-vous
https://docs/screenshots/06-appointments.png

Gestion des médecins
https://docs/screenshots/07-doctors.png

Consultations
https://docs/screenshots/08-consultations.png
...
☑ CRUD Patients avec archivage
☑ CRUD Services médicaux
☑ Gestion des Médecins (User + Doctor)
☑ Rendez-vous avec détection de chevauchement
☑ Consultations et dossier médical automatique
☑ Tableau de bord avec graphiques
☑ Design system complet (React + Tailwind)
☑ Module d'intelligence artificielle (prévisions de charge)
