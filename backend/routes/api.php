...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::get('appointments/today', [DashboardController::class, 'appointmentsToday'])
            ->name('dashboard.appointments.today');
        Route::get('appointments/upcoming', [DashboardController::class, 'appointmentsUpcoming'])
    ...
    Route::prefix('ai')->group(function () {
        Route::get('predictions', [AiController::class, 'predictions'])
            ->name('ai.predictions');
        Route::get('trends', [AiController::class, 'trends'])
            ->name('ai.trends');
    });
